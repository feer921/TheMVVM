...
//    }
    ...
    public static boolean preventFastClickView(View clickedView, long needGapMillTimes) {
        ...
        if (!CheckUtil.isEmpty(lastClickTimeStr)) {
            try {
